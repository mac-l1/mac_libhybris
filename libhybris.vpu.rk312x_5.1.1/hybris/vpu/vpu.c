...
#include <android/librkvpu/vpu_api.h>
#include <android/librkvpu/vpu.h>
#include <android/librkvpu/vpu_mem_pool.h>

#define VPU_LIBRARY_PATH "/system/lib/libvpu.so"
#define RK_VPUAPI_LIBRARY_PATH "/system/lib/librk_vpuapi.so"

HYBRIS_LIBRARY_INITIALIZE(vpu, VPU_LIBRARY_PATH);
HYBRIS_LIBRARY_INITIALIZE(rk_vpuapi, RK_VPUAPI_LIBRARY_PATH);
...
HYBRIS_IMPLEMENT_FUNCTION1(rk_vpuapi, RK_S32, vpu_open_context, struct VpuCodecContext **);
// RK_S32 vpu_close_context(struct VpuCodecContext **ctx);
HYBRIS_IMPLEMENT_FUNCTION1(rk_vpuapi, RK_S32, vpu_close_context, struct VpuCodecContext **);
